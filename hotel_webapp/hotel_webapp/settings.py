...
SECRET_KEY = 'django-insecure-nz7bg(qtl^#k&z2xj2jmy(44q^hh1%h*lp_&)ns5ynz!^x0%%+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
EMAIL_HOST = "smtp.hostinger.com"
EMAIL_HOST_USER = "info@onefinserv.in"
EMAIL_HOST_PASSWORD = "Pardeep@26"
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_BACKEND = "django.core.mail.backends.smtp.EmailBackend"

ALLOWED_HOSTS = ["192.168.29.57","127.0.0.1"]
